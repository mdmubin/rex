...
template <class t, unsigned n = 0>    struct extent          : integral_constant<usz, 0> {};
template <class t>                    struct extent<t[], 0>  : integral_constant<usz, 0> {};
template <class t, unsigned n>        struct extent<t[], n>  : extent<t, n - 1> {};
template <class t, usz l>             struct extent<t[l], 0> : integral_constant<usz, l> {};
template <class t, usz l, unsigned n> struct extent<t[l], n> : extent<t, n - 1> {};
