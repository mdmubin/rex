...
template <typename t>               struct disjunction<t>       : bool_constant<bool(t::value)> {};
template <typename t, typename...u> struct disjunction<t, u...> : bool_constant<bool(t::value) || disjunction<u...>::value> {};
